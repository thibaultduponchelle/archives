...
sub patch {
    ...
    foreach my $patch_filename (($self->get_patch_series, self->get_patch_from_distroprefs)) {
...
sub get_patch_from_distroprefs {
    my $self = shift;
    my $name = shift || $self->clean_meta_name;
    
    my $prefs_folder = "/home/tib/.local/share/.cpan/prefs/";
    my $patches_folder = "/home/tib/.local/share/.cpan/patches/"; 
